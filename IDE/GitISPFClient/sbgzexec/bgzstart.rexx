...
/*********************************************************************/
  ...
  /* Set the location for Java, Git and DBB */
  Call BGZCONF
  'VGET (BGZJAVAH,BGZGITH,BGZBASH,BGZCGIT,BGZMAN,BGZPERL5,BGZDBBH) SHARED'
  ...
  gitenv.6  = 'export PATH=$PATH:$JAVA_HOME/bin:'BGZGITH'/bin'
