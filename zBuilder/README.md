...
--- | --- | ---
| [Add Cli Args to Build Context](AddCliArgsToBuildContext/) | Custom Groovy Task | This custom groovy task adds the CLI arguments with their value as variables into the build context. The variables can be used by subsequent tasks and language tasks. |
