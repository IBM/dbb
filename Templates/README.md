...
<br /> | .gitlab-ci.yml definition file, to query the evidence file using the queryTemplate.yml template. | [GitlabCIPipeline/Reporting-pipeline/wazi-deploy-query/README.md](GitlabCIPipeline/Reporting-pipeline/wazi-deploy-query/README.md)
