...
Gitlab CI/CD Pipeline Template | Template to set a [Gitlab CI/CD pipeline](https://docs.gitlab.com/ee/ci/pipelines/) to build, package and deploy Gitlab Repos Git. | [GitlabCIPipeline/README.md](GitlabCIPipeline.README.md)
