...
Gitlab CI/CD Pipeline Template | • .gitlab-ci.yml template to setup a [Gitlab CI/CD pipeline](https://docs.gitlab.com/ee/ci/pipelines/) to build, package and deploy Gitlab platform. git <br /> <br /> • .gitlab-ci.yml definition file, to query the evidence file using the queryTemplate.yml template. | <br />[GitlabCIPipeline/README.md](GitlabCIPipeline/README.md) <br /> <br />[GitlabCIPipeline/Reporting-pipeline/wazi-deploy-query/README.md](https://github.com/thadbeerafarhath/dbb/blob/feature/query-template/Templates/GitlabCIPipeline/Reporting-pipeline/wazi-deploy-query/README.md)
