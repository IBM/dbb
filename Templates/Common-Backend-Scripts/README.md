...
-b `<branch>`| (Deprecated) Name of the **git branch** turning into a segment of the directory path for the location within the artifact repository for the `build` pipelineType.
