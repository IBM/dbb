...
Help() {
  ...
  echo "                 Ex: USER.APP                                 "  
  echo "                                                              " 
  echo "       -t                 - (Optional) zAppBuild build        "
  echo "                             options override argument to     "
  echo "                             directly specify the build       "
  echo "                             parameters. Must be surrounded   "
  echo "                             by single quotes.                "
  echo "                 Ex: -t '--fullBuild'                         "
  echo "                                                              "
